let tabla = document.getElementById("tablaKenai");
let texto = document.getElementById("textoAlerta");

urlal = 'http://industrial.api.ubidots.com/api/v1.6/devices/kenai/alerta/values?token=';
urla = 'http://industrial.api.ubidots.com/api/v1.6/devices/kenai/aceleracion/values?token=';
urlr = 'http://industrial.api.ubidots.com/api/v1.6/devices/kenai/ritmo-cardiaco/values?token=';
